...
def insert_contents(doc, config):
    ...
    # doc.Paragraphs(5).Range.InsertParagraphBefore()
    # print(toc.Range.Paragraphs[-1].Next())
    a = toc.Range.Paragraphs
    toc.Range.Paragraphs[toc.Range.Paragraphs.Count-1].Next().Range.InsertBreak(WdBreakType.wdSectionBreakOddPage)
