...
newListTemplate = doc.ListTemplates.Add(Name="新列表模板1")
...
listLevel1.TrailingCharacter = 1
listLevel1.NumberStyle = 37
listLevel1.NumberPosition = 0
listLevel1.Alignment = 0
listLevel1.TextPosition = 0
listLevel1.TabPosition = 9999999
listLevel1.ResetOnHigher = 0
listLevel1.StartAt = 1

style1 = styles.Add("my6标题 1", 1)
